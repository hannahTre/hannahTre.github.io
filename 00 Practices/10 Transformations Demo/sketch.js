...
function draw() {
  //each frame, coord system resets to normal
  background(255);
  drawBasicGrid(200);

  //transformation one: TRANSLATION
  // push(); //makes a new coord system on top
  // translate(120,120);
  // drawBasicGrid(150);
  // rectangleRed(0,0);
  // pop(); //reverts back to previous coord system
  ...
  // translate(140,140);
  // face(0,0);
  // rotate(radians(frameCount)); //always around origin (0,0)
  // //drawBasicGrid(100);
